      ...
      <section className="max-w-6xl mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="space-y-2">
            <Link href="/careers" className="text-sm text-teal-700 font-semibold underline">
              Careers / Job Detail
            </Link>
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-700 leading-relaxed">{job.overview || job.summary}</p>
          </div>
          ...
          <div className="space-y-3">
            <h2 className="text-lg font-semibold text-gray-900">What We Expect From You</h2>
            <ul className="list-disc pl-5 space-y-2 text-gray-700">
          ...
          <div className="flex flex-wrap gap-3 pt-4">
            <a
              href={mailtoHref}
              className="px-5 py-3 rounded-lg bg-teal-600 text-white text-sm font-semibold hover:bg-teal-700"
            >
        ...
        <aside className="space-y-6">
            ...
            <div className="space-y-3 text-sm text-gray-700">
              ...
              {job.workingStyle && (
                <div>
                  ...
                  <p>{job.workingStyle}</p>
                </div>
              )}
            </div>
            <a
              href={mailtoHref}
              className="mt-5 inline-flex w-full justify-center px-4 py-2.5 rounded-lg bg-teal-600 text-white text-sm font-semibold hover:bg-teal-700"
            >
              Quick Apply
            </a>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-2xl p-5 text-sm text-gray-700">
            ...
            <a href={`mailto:${job.email}`} className="text-teal-700 font-semibold">{job.email}</a>
          </div>
        </aside>
      </section>
    </main>
